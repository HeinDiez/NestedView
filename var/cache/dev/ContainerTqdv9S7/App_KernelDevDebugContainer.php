...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'twig.cache.tailwind' => 'getTwig_Cache_TailwindService',
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\PlanetController' => 'getPlanetControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/tales-from-a-dev/twig-tailwind-extra/src/TailwindExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1Jawm9TjYQ', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.symfonycasts.tailwind_bundle'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NOyZJmgIy7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wc1gsSGNzu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NVNqCiMM0s', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDataCollector_CacheService($container)
    {
        ...
        $instance->addInstance('twig.cache', ($container->services['twig.cache.tailwind'] ?? self::getTwig_Cache_TailwindService($container)));
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\PlanetRepository' => ['privates', 'App\\Repository\\PlanetRepository', 'getPlanetRepositoryService', true],
            'App\\Repository\\VoyageRepository' => ['privates', 'App\\Repository\\VoyageRepository', 'getVoyageRepositoryService', true],
        ], [
            'App\\Repository\\PlanetRepository' => '?',
    ...
    /**
     * Gets the public 'twig.cache.tailwind' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected static function getTwig_Cache_TailwindService($container)
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mDu0IHMFfp', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));

        return $container->services['twig.cache.tailwind'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/symfony/ux-turbo/src/DependencyInjection/../../assets/dist') => '@symfony/ux-turbo', (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/src/DependencyInjection/../../assets/dist') => '@symfony/ux-autocomplete', (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', 'assets/' => '', (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/public') => 'bundles/babdevpagerfanta'], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#']);
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gIhQhpd65p', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hnPyxu944X', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fM7XTZO552', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o0FKlEUVHd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PvGJnd-0U1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.af.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.af.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.af.xlf')], 'ar' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ar.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ar.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ar.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ar.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.ar.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.ar.xliff')], 'az' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.az.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.az.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.az.xlf'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.az.xliff')], 'be' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.be.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.be.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.be.xlf')], 'bg' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.bg.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.bg.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.bg.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.bg.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.bg.php')], 'bs' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.bs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.bs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.bs.xlf')], 'ca' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ca.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ca.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ca.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ca.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.ca.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.ca.xliff')], 'cs' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.cs.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.cs.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.cs.xliff')], 'cy' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.cy.xlf')], 'da' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.da.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.da.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.da.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.da.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.da.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.da.xliff')], 'de' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.de.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.de.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.de.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.de.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.de.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.de.xliff')], 'el' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.el.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.el.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.el.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.el.php')], 'en' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.en.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.en.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.en.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.en.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.en.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.en.xliff')], 'es' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.es.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.es.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.es.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.es.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.es.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.es.xliff')], 'et' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.et.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.et.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.et.xlf')], 'eu' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.eu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.eu.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.eu.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.eu.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.eu.xliff')], 'fa' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fa.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fa.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fa.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.fa.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.fa.xliff')], 'fi' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fi.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.fi.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.fi.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.fi.xliff')], 'fr' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fr.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.fr.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.fr.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.fr.xliff')], 'gl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.gl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.gl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.gl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.gl.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.gl.xliff')], 'he' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.he.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.he.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.he.xlf')], 'hr' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.hr.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.hr.xliff')], 'hu' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hu.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.hu.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.hu.php')], 'hy' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hy.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hy.xlf')], 'id' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.id.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.id.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.id.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.id.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.id.php')], 'it' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.it.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.it.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.it.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.it.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.it.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.it.xliff')], 'ja' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ja.xliff')], 'lb' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.lb.php')], 'lt' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lt.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.lt.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.lt.php')], 'lv' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lv.xlf')], 'mk' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.mk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.mk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.mk.xlf')], 'mn' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.mn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.mn.xlf')], 'my' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.my.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.my.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.my.xlf')], 'nb' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nb.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.nb.xliff')], 'nl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nl.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.nl.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.nl.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.nl.xliff')], 'nn' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nn.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.nn.xliff')], 'no' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.no.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.no.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.no.xlf'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.no.xliff')], 'pl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pl.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.pl.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.pl.xliff')], 'pt' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pt.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pt.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.pt.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.pt.xliff')], 'pt_BR' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pt_BR.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pt_BR.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pt_BR.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.pt_BR.php')], 'ro' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ro.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ro.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ro.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ro.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.ro.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.ro.xliff')], 'ru' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ru.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.ru.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.ru.xliff')], 'sk' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sk.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sk.xliff'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.sk.xliff')], 'sl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sl.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sl.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.sl.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.sl.xliff')], 'sq' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sq.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sq.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sq.xlf')], 'sr_Cyrl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sr_Cyrl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sr_Cyrl.xlf'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.sr_Cyrl.xliff')], 'sr_Latn' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sr_Latn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sr_Latn.xlf'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.sr_Latn.xliff')], 'sv' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sv.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sv.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.sv.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.sv.xliff')], 'th' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.th.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.th.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.th.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.th.xliff'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.th.xliff')], 'tl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.tl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.tl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.tl.xlf')], 'tr' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.tr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.tr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.tr.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.tr.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.tr.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.tr.xliff')], 'uk' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.uk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.uk.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.uk.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.uk.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.uk.xliff')], 'ur' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ur.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ur.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ur.xlf')], 'uz' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.uz.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.uz.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.uz.xlf')], 'vi' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.vi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.vi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.vi.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.vi.xliff')], 'zh_CN' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.zh_CN.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.zh_CN.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh_CN.xliff'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.zh_CN.php'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.zh_CN.xliff')], 'zh_TW' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.zh_TW.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.zh_TW.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh_TW.xliff')], 'bs_Latn_BA' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.bs_Latn_BA.xliff')], 'eo' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.eo.xliff')], 'hr_HR' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.hr_HR.xliff')], 'ky' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ky.xliff')], 'pt_PT' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pt_PT.xliff')], 'sr_Latin' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sr_Latin.xliff')], 'zh' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh.xliff')], 'zh_HK' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh_HK.xliff')], 'sr_RS' => [(\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations/AutocompleteBundle.sr_RS.php')], 'oc' => [(\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.oc.xliff')], 'sw' => [(\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations/pagerfanta.sw.xliff')]], 'scanned_directories' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-autocomplete/translations'), (\dirname(__DIR__, 4).'/vendor/babdev/pagerfanta-bundle/translations'), (\dirname(__DIR__, 4).'/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-migrations-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/twig-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/twig/extra-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/maker-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/web-profiler-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/monolog-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/debug-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-fixtures-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/zenstruck/foundry/src/translations'), (\dirname(__DIR__, 4).'/vendor/symfonycasts/tailwind-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/tales-from-a-dev/twig-tailwind-extra/src/Bridge/Symfony/translations'), (\dirname(__DIR__, 4).'/vendor/tales-from-a-dev/flowbite-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/ux-turbo/translations')], 'cache_vary' => ['scanned_directories' => ['vendor/symfony/validator/Resources/translations', 'vendor/symfony/form/Resources/translations', 'vendor/symfony/security-core/Resources/translations', 'vendor/knplabs/knp-time-bundle/translations', 'vendor/symfony/ux-autocomplete/translations', 'vendor/babdev/pagerfanta-bundle/translations', 'translations', 'vendor/symfony/framework-bundle/translations', 'vendor/doctrine/doctrine-bundle/translations', 'vendor/doctrine/doctrine-migrations-bundle/translations', 'vendor/symfony/twig-bundle/translations', 'vendor/twig/extra-bundle/translations', 'vendor/symfony/maker-bundle/src/translations', 'vendor/symfony/web-profiler-bundle/translations', 'vendor/symfony/monolog-bundle/translations', 'vendor/symfony/debug-bundle/translations', 'vendor/doctrine/doctrine-fixtures-bundle/translations', 'vendor/zenstruck/foundry/src/translations', 'vendor/symfonycasts/tailwind-bundle/src/translations', 'vendor/tales-from-a-dev/twig-tailwind-extra/src/Bridge/Symfony/translations', 'vendor/tales-from-a-dev/flowbite-bundle/translations', 'vendor/symfony/stimulus-bundle/translations', 'vendor/symfony/ux-turbo/translations']]], []);
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/debug-bundle/Resources/views'), '!Debug');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/tales-from-a-dev/flowbite-bundle/templates'), 'TalesFromADevFlowbite');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/tales-from-a-dev/flowbite-bundle/templates'), '!TalesFromADevFlowbite');
        ...
        $instance->addExtension(new \TalesFromADev\Twig\Extra\Tailwind\TailwindExtension());
        ...
        $instance->addRuntimeLoader(new \Twig\RuntimeLoader\ContainerRuntimeLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'TalesFromADev\\Twig\\Extra\\Tailwind\\TailwindRuntime' => ['privates', 'twig.runtime.tailwind', 'getTwig_Runtime_TailwindService', true],
            ...
            'TalesFromADev\\Twig\\Extra\\Tailwind\\TailwindRuntime' => '?',
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'TalesFromADevTwigExtraTailwindBundle' => 'TalesFromADev\\Twig\\Extra\\Tailwind\\Bridge\\Symfony\\Bundle\\TalesFromADevTwigExtraTailwindBundle',
                'TalesFromADevFlowbiteBundle' => 'TalesFromADev\\FlowbiteBundle\\TalesFromADevFlowbiteBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'TalesFromADevTwigExtraTailwindBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/tales-from-a-dev/twig-tailwind-extra/src/Bridge/Symfony'),
                    'namespace' => 'TalesFromADev\\Twig\\Extra\\Tailwind\\Bridge\\Symfony\\Bundle',
                ],
                'TalesFromADevFlowbiteBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/tales-from-a-dev/flowbite-bundle'),
            ...
            'twig.form.resources' => [
                ...
                2 => '@TalesFromADevFlowbite/form/default.html.twig',
            ],
